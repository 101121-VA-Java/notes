...
public class EmployeeController {
	...
	/*
	 * getEmployees will be used to handle several behaviors at /employees using query params
	 * 		- /employees
	 * 			- return all employees
	 * 		- /employees?username=[value]
	 * 			- return employee with a specific username
	 * 		- /employees?manager-id=[value]
	 * 			- return all employees with a specific manager id 
	 */
	public static void getEmployees(Context ctx) {
		...
		// if a query param for username has been passed in, execute retrieve by username behavior
		if (username != null) {
		...
		// if a query param for manager id has been passed in, execute retrieve by manager id behavior
	...
	public static void registerEmployee(Context ctx) {
		 ...
		 * 	- headers 
		 * 	- body 
		 * 		- need to have name, username, password 
		 * 	- url 
